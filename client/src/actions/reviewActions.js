...
import { ADD_MY_NEW_REVIEW, ALL_REVIEWS_FAIL, ALL_REVIEWS_REQUEST, ALL_REVIEWS_SUCCESS, CHANGE_LIKE_FAIL, CHANGE_LIKE_IN_USER_DATA, CHANGE_LIKE_REQUEST, CHANGE_LIKE_SUCCESS, CREATE_REVIEW_FAIL, CREATE_REVIEW_REQUEST, CREATE_REVIEW_SUCCESS } from '../constents';
...
export const getReviews = () => async (dispatch) => {
  try {
     dispatch({type: ALL_REVIEWS_REQUEST});
      ...
      const myreviews = [];
      if (store.getState().userInfo.user._id) {
